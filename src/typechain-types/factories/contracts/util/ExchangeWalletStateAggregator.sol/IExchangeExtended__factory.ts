...
import type {
  IExchangeExtended,
  IExchangeExtendedInterface,
} from '../../../../contracts/util/ExchangeWalletStateAggregator.sol/IExchangeExtended';
...
export class IExchangeExtended__factory {
  static readonly abi = _abi;
  static createInterface(): IExchangeExtendedInterface {
    return new Interface(_abi) as IExchangeExtendedInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null,
  ): IExchangeExtended {
    return new Contract(address, _abi, runner) as unknown as IExchangeExtended;
  }
}
