...
export interface KumaOFTAdapterUSDCInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'SEND'
      | 'SEND_AND_CALL'
...
export interface KumaOFTAdapterUSDC extends BaseContract {
  connect(runner?: ContractRunner | null): KumaOFTAdapterUSDC;
  waitForDeployment(): Promise<this>;

  interface: KumaOFTAdapterUSDCInterface;
