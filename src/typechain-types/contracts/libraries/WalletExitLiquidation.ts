...
export interface WalletExitLiquidationInterface extends Interface {
  getEvent(nameOrSignatureOrTopic: 'LiquidatedWalletExit'): EventFragment;
}
...
export interface WalletExitLiquidation extends BaseContract {
  connect(runner?: ContractRunner | null): WalletExitLiquidation;
  waitForDeployment(): Promise<this>;

  interface: WalletExitLiquidationInterface;
